...
var getRandomKeyForArray = function(arr, length) {
  ...
  if (findMatches(arr, randomKey) === true) return getRandomKeyForArray(arr, length);
...
document.querySelector("#offer-dialog").replaceChild(activeUserInfo, document.querySelector(".dialog__panel"));
